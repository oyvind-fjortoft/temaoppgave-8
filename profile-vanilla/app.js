...
function greet() {
    ...
    form.innerHTML += '<p>Det var veldig hyggelig at du ville være med på prosjektet.'
    form.innerHTML += '<p>Om jeg forstår det riktig, er navnet ditt ' + name.value + ', og eposten din er: ' + email.value
